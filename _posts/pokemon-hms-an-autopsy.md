...
**HMs are hard to unlearn.** Further, HMs, once learned, cannot be easily unlearned. This is a necessary evil to prevent a player entering an area using an HM move, unlearning that move, and then being unable to get back. They can only be removed at a specific location in each game.
